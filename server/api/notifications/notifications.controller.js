  ...
  if (req.query.projectId) {
    getNotificationTypes(permissionArray)
      .then((notification) => {
        ...
        findNotificationsMob(req, query).then((data) => {
          let notifications = [];
          notifications = data;
          query = {
            where: {
          ...
          findNotificationsMob(req, query).then((data2) => {
    ...
    .then((notification) => {
      ...
      getProjectList(req.authData.PM_UserID, req.authData.PM_Client_ID)
        .then((projectIds) => {
          ...
          findNotifications(req, query).then((data) => {
            let notifications = [];
            notifications = data;
            query = {
              where: {
            ...
            findNotifications(req, query).then((data2) => {
              notifications = notifications.concat(data2);
